...
export function ChatbotWidget() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        className="fixed bottom-5 right-5 z-50 flex h-13 w-13 items-center justify-center rounded-full bg-teal-600 text-white shadow-lg transition hover:bg-teal-700"
